...
export class Contents {
  ...
  private glitchPlane: GlitchPlane | null;
  ...
  public update(deltaTime: number) {
    ...
    this.glitchPlane!.update(deltaTime);
  ...
  public async init( textures: TextureAssets ) {
    ...
    this.camera.init();
    this.glitchPlane = new GlitchPlane(textures);
    this.scene.add(this.glitchPlane);
    this.setGui();
  }

  private setGui() {
    this.glitchPlane!.setGui(this.pane);
